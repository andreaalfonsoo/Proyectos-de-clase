...
public class VistaVentana extends JFrame {
	...
	public VistaVentana() {
		...
		getContentPane().add(vp, "VistaPrincipal"); //CardLayout añade la vista ventana que tu quieras //Siempre hay que poner un String
		//Se puede hacer nuevo un contenedor que "vacie" el JPanel y asi poder mostrar otra ventana
